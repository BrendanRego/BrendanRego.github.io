...
<html>
  <body>
    ...
    <img src="Headshot 2.JPG" alt="Brendan Rego Headshot">
    
    <p>I am originally from the South Coast of Massachusetts, and I have had six family members attend Lehigh in the last two generations, including my mother, grandfather, and my aunts and uncles.</p>
    ...
    <p>That is the question I was attempting to answer by looking into the campaign finance data of the top Democrat and Republican candidates in the upcoming general election this fall</p>
    ...
    <p>The following timeline shows some of the most significant campaign finance laws that have been passed in American History. While the acts that are passed and repealed are all self-explanatory in isolation, there is a larger narrative that reveals itself when looking at the evolution of regulations as a whole</p>
  ...
  <iframe src='https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1C_Tug8O6lJmLkEg62IXKDShB4FoTCJDawghzxsI6w4M&font=Default&lang=en&initial_zoom=2&height=650' width='100%' height='650' webkitallowfullscreen mozallowfullscreen allowfullscreen frameborder='0'></iframe>
    ...
    <p>Taking a detour from the campaign finance stories that I have been focused on so far in this course, for this assignment, I decided to look at the average annual temperature increase from the 1901-2000 average. This idea seemed perfect for a time series graph and would be able to highlight any dangerous trends that may not be visible without data visualization.</p>
    ...
    <p>This sample project was intended to show where students at Lehigh prefer to attend parties. What I find interesting about this data is the discrepancy between male and female respondents. While female students have a clear preference for off-campus parties, male students don't have a very strong preference either way, with a slim majority preferring fraternity parties.</p>
    ...
    <p>Is the poverty line high enough to be a barometer for the national cost of living? Is the poverty line increasing at a fair rate compared to the cost of living? These are the questions that I am examining for this final Tableau project in the course. I am getting my poverty line data from the Office of Planning and Evaluation's record of the Federal Register over time, and I am getting my cost of living data from the statistical analysis company Statistica's evaluation of national consumer indexes per year from 1990-2020.</p>
